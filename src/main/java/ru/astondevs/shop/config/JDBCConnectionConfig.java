...
public class JDBCConnectionConfig {
    ...
    static {
        log.info("Loading ru.astondevs.shop.config file and parameters from application.properties");
        ...
        try (InputStream input = JDBCConnectionConfig.class
            ...
            log.info("Successfully load ru.astondevs.shop.config file from application.properties");
            ...
            throw new RuntimeException("Exception while loading ru.astondevs.shop.config file and parameters from application.properties");
        }
        log.info("Successfully load ru.astondevs.shop.config file and parameters from application.properties");
    }
